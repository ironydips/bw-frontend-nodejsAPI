        ...
        $stateProvider
            ...
            .state('test', {
                ...
                views: {
                    ...
                    'adminSubPanel@test': {
                        template: '<test-sub-panel></test-sub-panel>'
                    }
                }
            })
            .state('test.testDriverList', {
                url: '/testDriverList',
                views: {
                    'contentSection@test': {
                        template: '<test-driver-list></test-driver-list>'
                    }
                }
            })
            .state('test.testTruckList', {
                url: '/testTruckList',
                views: {
                    'contentSection@test': {
                        template: '<test-truck-list></test-truck-list>'
                    }
                }
            })
    }
